...
public class TotalServiceConfigTest {
    ...
    @Bean
    public TotalService getTotalIncomeServiceBean(ValidationUtil validationUtil, RepositoryData<Income> repositoryData, MapperUtil mapperUtil, IndexUtil<IncomeDto> indexUtil, TotalServiceUtil totalServiceUtil) {
        return new IncomeServiceImpl(validationUtil, repositoryData, mapperUtil, indexUtil, totalServiceUtil);
    }

    @Bean
    public TotalService getTotalCostServiceBean(ValidationUtil validationUtil, RepositoryData<Cost> repositoryData, MapperUtil mapperUtil, IndexUtil<CostDto> indexUtil, TotalServiceUtil totalServiceUtil) {
